...
import { Button, Tabbar, TabbarItem, NavBar, Icon, Search, Row, Col, NoticeBar, Swipe, SwipeItem, Lazyload, Toast, Tab, Tabs, List, Dialog, Cell, CellGroup, Field, Sticky } from 'vant';
Vue.use(Button).use(Tabbar).use(TabbarItem).use(NavBar)
  ...
  .use(Tabs).use(List).use(Dialog).use(Cell).use(CellGroup).use(Field).use(Sticky);
